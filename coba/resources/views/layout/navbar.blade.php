  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light pb-2 pt-2">
      <div class="container-fluid">
        <a class="fs-5 fw-bold "style="color:black;text-decoration:none;" href="/">LOGO</a>
...
<ul class="navbar-nav ms-auto">
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
      <li><a class="dropdown-item" href="/profile/{{ auth()->user()->nama}}">Profile</a></li>
      <li><a class="dropdown-item" href="/admin/listpackage">Administrative</a></li>{{-- vendor --}}
      <li><a class="dropdown-item" href="#">Keranjang</a></li>{{-- guest --}}
